...
public class Assignment2Part3 extends WindowProgram {
    ...
    //Amounts of toes for each paw
    private static final int AMOUNTS_OF_TOES = 3;
    ...
    private void drawToes(double x, double y) {
        ...
        for (int i = 0; i < AMOUNTS_OF_TOES; i++) {
            int yToesCoordinate = 0;
            if (i % 2 == 0) {
                yToesCoordinate = (int) (FIRST_TOE_OFFSET_Y * 1);
            }
            drawOval((SECOND_TOE_OFFSET_X * i) + x,
                    yToesCoordinate + y,
                    TOE_WIDTH,
                    TOE_HEIGHT
            );
